...
public class CombinedCyclePlant extends PowerPlants{
    ...
    static final LocalTime RESTART_TIME = LocalTime.of(2,0);
    static final double STABILITY = 0.7;
    static final String ELEMENT_BURNED = "Natural gas";
    String icon = "combined_cycle.png";
    double maxCapacityMW;

    public CombinedCyclePlant(String type, String name, double latitude, double longitude, String city, double maxCapacityMW, double efficiency) {
