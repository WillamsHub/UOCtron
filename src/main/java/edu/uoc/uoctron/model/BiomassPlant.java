...
public class BiomassPlant extends PowerPlants{
    ...
    static final LocalTime RESTART_TIME = LocalTime.of(3,0);
    static final double STABILITY = 0.5;
    static final String ELEMENT_BURNED = "Biomass";
    String icon = "biomass.png";
