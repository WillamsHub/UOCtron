...
public class CoalPlant extends PowerPlants{
    ...
    static final LocalTime RESTART_TIME = LocalTime.of(8,0);
    static final double STABILITY = 0.9;
    static final String ELEMENT_BURNED = "Coal";
    String icon = "coal.png";
    double maxCapacityMW;

    public CoalPlant(String type, String name, double latitude, double longitude, String city, double maxCapacityMW, double efficiency) {
