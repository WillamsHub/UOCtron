...
public class HydroPlant extends PowerPlants{
    ...
    static final LocalTime RESTART_TIME = LocalTime.of(0,3);
    static final double STABILITY = 0.8;
    String icon = "hydro.png";
    double maxCapacityMW;


    public HydroPlant(String type, String name, double latitude, double longitude, String city, double maxCapacityMW, double efficiency) {
